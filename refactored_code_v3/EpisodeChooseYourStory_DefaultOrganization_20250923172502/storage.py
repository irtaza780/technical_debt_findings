...
def _write_json_file(file_path: str, data: Dict[str, Any]) -> None:
    ...
    Args:
        ...
        data: Dictionary to serialize and write to the file.
...
def save_game_dialog(data_provider_callable: Callable[[], Dict[str, Any]]) -> None:
    ...
    try:
        ...
        logger.error(f"Failed to save game to {file_path}: {e}")
