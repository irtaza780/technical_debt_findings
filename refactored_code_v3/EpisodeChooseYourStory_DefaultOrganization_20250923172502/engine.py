...
class Choice:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Choice":
        ...
        Args:
            data: Dictionary containing text, target, and optional conditions/effects.
...
class StoryNode:
    ...
    def from_dict(cls, node_id: str, data: Dict[str, Any]) -> "StoryNode":
        ...
        Args:
            node_id: Unique identifier for this node.
            data: Dictionary containing text and optional choices.
...
class StoryEngine:
    ...
    def __init__(self, story_data: Dict[str, Any]):
        ...
        # Determine start node with fallback to first available node
        ...
        if not self.start_node_id:
            logger.error("No valid start node found in story data")
            raise ValueError("Story must contain at least one node")
    ...
    def get_current_node(self) -> StoryNode:
        ...
        Returns:
            The StoryNode at the current position.

        Raises:
            KeyError: If current node ID is not found in nodes.
        """
