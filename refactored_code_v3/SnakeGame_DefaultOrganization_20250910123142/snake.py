...
class Snake:
    ...
    def move(self, grow=False):
        ...
        Args:
            grow: If True, the snake grows by one segment (tail is retained).
                  If False, the tail is removed, maintaining current length.
    ...
    def collides_with_self(self):
        ...
        for segment in body_without_head:
            if segment == head:
                logger.debug(f"Self-collision detected at {head}")
                return True
