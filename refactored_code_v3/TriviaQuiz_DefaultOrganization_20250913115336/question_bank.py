...
def _parse_question_from_json_item(item: dict, item_index: int) -> tuple[Question | None, str | None]:
    ...
    Args:
        item: The JSON object representing a question.
...
def load_bank_from_json(path: str) -> List[Question]:
    ...
    Raises:
        ...
        ValueError: If the JSON root is not a list or no valid questions were parsed.
    """
    try:
    ...
    # Raise error if no valid questions were parsed
