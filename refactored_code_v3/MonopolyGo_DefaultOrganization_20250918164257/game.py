...
class Tile:
    ...
    def land(self, game: "Game", player: Player) -> List[str]:
        """
        Process a player landing on this tile.
...
class PropertyTile(Tile):
    ...
    def land(self, game: "Game", player: Player) -> List[str]:
        ...
        if self.owner is None:
            ...
            # Pay rent to owner
            self._collect_rent(game, player, messages)

        return messages

    def _collect_rent(self, game: "Game", player: Player, messages: List[str]) -> None:
        """
        Collect rent from a player.

        Args:
            game: The game instance.
            player: The player paying rent.
            messages: List to append rent message to.
        """
...
class ChanceTile(Tile):
    ...
    def land(self, game: "Game", player: Player) -> List[str]:
        """
        Process landing on a chance tile.
...
class FreeParkingTile(Tile):
    ...
    def land(self, game: "Game", player: Player) -> List[str]:
        """
        Process landing on Free Parking.
...
class JailTile(Tile):
    ...
    def land(self, game: "Game", player: Player) -> List[str]:
        """
        Process landing on Jail (just visiting).
...
class Board:
    ...
    def _build(self) -> None:
        """Build the board with all 20 tiles."""
        # 0: GO
...
class Game:
    ...
    def attempt_purchase_current_tile(self) -> str:
        """
        Attempt to purchase the current pending property.

        Returns:
            str: Message describing the purchase outcome.
        """
