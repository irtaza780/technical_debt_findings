...
class ConnectFourGame:
    ...
    def get_board(self) -> Tuple[Tuple[int, ...], ...]:
        ...
        Returns:
            ...
            is a row and each element is a cell value (0, 1, or 2).
        """
    ...
    def count_in_direction(
        ...
        in both the (row_delta, col_delta) and opposite directions.
    ...
    def check_win(self, row: int, col: int) -> bool:
        ...
        for row_delta, col_delta in WIN_CHECK_DIRECTIONS:
            if self.count_in_direction(row, col, row_delta, col_delta, player) >= WINNING_LENGTH:
                return True
