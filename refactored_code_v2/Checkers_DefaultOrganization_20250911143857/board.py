...
class Piece:
    ...
    Attributes:
        ...
        king: Whether the piece has been promoted to a king.
    """
...
class Board:
    ...
    def move_piece(
        ...
        Args:
            from_pos: Tuple of (row, col) for the source position.
            to_pos: Tuple of (row, col) for the destination position.
        """
    ...
    def draw(
        ...
        If pygame is unavailable, this method does nothing.
    ...
    def _get_highlight_color(
        ...
        Args:
            from_row: Source row coordinate.
            from_col: Source column coordinate.
            to_row: Destination row coordinate.
            to_col: Destination column coordinate.
