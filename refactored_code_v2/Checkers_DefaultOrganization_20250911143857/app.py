...
class GameApp:
    ...
    def reset(self) -> None:
        ...
        self._initialize_game_state()
        self.status_message = NEW_GAME_MESSAGE
        self.status_color = STATUS_OK_COLOR
    ...
    def _handle_successful_move(self, msg: str) -> None:
        """
        Handle the aftermath of a successful move.
        
        Args:
            msg: Optional message from the move validation.
        """
        next_player = "Black" if self.state.current_player == "black" else "Red"
    ...
    def _handle_game_over(self, winner: str | None, reason: str) -> None:
        """
        Handle game over state and display appropriate message.
    ...
    def _draw_panel(self) -> None:
        """Draw the bottom control panel with status and input."""
    ...
    def _draw_instructions(self) -> None:
        """Draw instruction text in the bottom panel."""
    ...
    def _draw_turn_indicator(self) -> None:
        ...
        current_player = "Red" if self.state.current_player == "red" else "Black"
