...
def _handle_mouse_input(event, buttons, difficulties):
    ...
    Returns:
        str or None: Selected difficulty name or None if no button clicked
    """
...
def _draw_difficulty_menu(screen, title_font, hint_font, buttons, start_y):
    ...
    Args:
        ...
        start_y (int): Y coordinate of button area start
    """
...
def _run_game_loop(screen):
    """
    Runs the main game loop, allowing user to play and return to menu.
