...
class Food:
    ...
    by the snake, and handles rendering the food on the game surface.
    """
    ...
    def _get_all_grid_cells(self):
        """
        Generate all valid cells on the game grid.
        
        Returns:
            set: Set of (x, y) tuples representing all grid positions.
        """
        return {
            (x, y)
    ...
    def _get_free_cells(self, snake_positions):
        """
        Calculate all cells not occupied by the snake.
    ...
    def spawn(self, snake_positions):
        ...
        if not free_cells:
            self.position = None
            logger.warning("No free cells available to spawn food")
            return False
    ...
    def draw(self, surface):
        """
        Draw the food as a filled rectangle on the game surface.
