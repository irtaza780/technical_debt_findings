...
def get_alien_color_by_index(alien_index: int) -> Tuple[int, int, int]:
    """
    Retrieve an alien color from the palette based on index.
...
def log_configuration() -> None:
    ...
    logger.info(
        ...
        f"Initial Speed={FLEET_INITIAL_SPEED}"
    )
    logger.info(f"Bullet: Cooldown={BULLET_FIRE_COOLDOWN_MS}ms, Speed={BULLET_VELOCITY}")