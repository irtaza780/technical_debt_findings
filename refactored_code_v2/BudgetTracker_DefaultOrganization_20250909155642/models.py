...
class Transaction:
    ...
    def _normalize_string(value: Optional[str], default: str = "") -> str:
        """Normalize string input with optional default value.
...
class BudgetModel:
    ...
    def __init__(self):
        ...
        self.savings_goal: float = INITIAL_SAVINGS_GOAL
    ...
    def load(
        ...
        savings_goal: float = INITIAL_SAVINGS_GOAL
    ) -> None:
        ...
        self.savings_goal = float(savings_goal) if savings_goal is not None else INITIAL_SAVINGS_GOAL
    ...
    def _calculate_next_id(self) -> int:
        ...
        Returns:
            Next ID based on maximum existing transaction ID
        """
    ...
    def set_savings_goal(self, goal: float) -> None:
        ...
        Args:
            goal: Target savings goal (must be non-negative)
        """
    ...
    def category_totals(self) -> Dict[str, float]:
        """Calculate total amount per category (income positive, expenses negative).
        ...
        for transaction in self.transactions:
            # Income adds to total, expenses subtract
    ...
    def filtered_transactions(
        ...
        Returns:
            List of transactions matching all specified criteria
        """
    ...
    def _normalize_filter_type(self, ttype: Optional[str]) -> Optional[str]:
        ...
        Returns:
            Normalized type or None if not specified
        """
        if not ttype:
            return None
    ...
    def _matches_filters(
        ...
        """Check if a transaction matches all specified filter criteria.
        ...
        if category and category != "All" and transaction.category != category:
            return False
