...
class MinesweeperApp(tk.Frame):
    ...
    def _build_board_frame(self):
        ...
        self.board_frame = tk.Frame(self, bg=BG_COLOR_BOARD, padx=PADDING_STANDARD, pady=PADDING_STANDARD)
    ...
    def _create_cell_button(self, x, y):
        """
        Create a single cell button with click bindings.
    ...
    def _schedule_timer_tick(self):
        ...
        self._update_timer_label()
        self.timer_id = self.after(TIMER_UPDATE_INTERVAL, self._schedule_timer_tick)
    ...
    def _update_timer_label(self, force_zero=False):
        ...
        Args:
            force_zero: If True, set timer to 0 regardless of elapsed time.
        """
        if force_zero:
