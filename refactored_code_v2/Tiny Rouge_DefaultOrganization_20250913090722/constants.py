...
class GameplayBalance:
    """Game balance parameters for difficulty and progression."""
    
    # Player attributes
    PLAYER_STARTING_HP = 100
    
    # Monster attributes
    MONSTER_HP_MINIMUM = 5
    MONSTER_HP_MAXIMUM = 30
    
    # Chest rewards
    CHEST_HEAL_MINIMUM = 20
    CHEST_HEAL_MAXIMUM = 30
...
def get_tile_color(tile_type):
    """
    Retrieve the display color for a given tile type.
    ...
    Raises:
        ValueError: If tile_type is not a recognized tile type
    """
    tile_color_map = {
...
def get_entity_color(entity_type):
    """
    Retrieve the display color for a given entity type.
