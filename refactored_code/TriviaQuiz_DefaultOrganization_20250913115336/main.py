...
class QuizApp(tk.Tk):
    ...
    def _setup_frame_container(self) -> None:
        """Set up the container frame and initialize all screen frames."""
    ...
    def start_quiz(
        ...
        logger.info(f"Started quiz with bank '{bank_name}', {count} questions")
...
class StartFrame(ttk.Frame):
    """Screen for selecting question bank and configuring quiz options."""
    ...
    def _build_options(self, parent: ttk.Frame) -> None:
        ...
        # Question count label and spinbox
        ...
        # Bank size label
        self.bank_size_label = ttk.Label(
            options_frame,
            text="Bank contains: 0 questions"
        )
    ...
    def refresh_banks(self) -> None:
        """Refresh the list of available banks and select the first one."""
    ...
    def update_bank_size(self) -> None:
        ...
        if bank_name in self.controller.banks:
            count = len(self.controller.banks[bank_name])
...
class QuizFrame(ttk.Frame):
    ...
    def __init__(self, parent, controller: QuizApp):
        """
        Initialize the quiz screen frame.
    ...
    def _build_layout(self) -> None:
        """Construct the UI layout for the quiz screen."""
        self._build_header()
    ...
    def _build_header(self) -> None:
        """Build the header with title and progress indicator."""
