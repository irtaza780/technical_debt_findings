...
class FibonacciApp:
    ...
    def __init__(self, master: tk.Tk) -> None:
        """
        Initialize the Fibonacci Generator GUI.
    ...
    def on_generate(self) -> None:
        ...
        try:
            ...
            error_message = str(e)
            messagebox.showerror("Invalid input", error_message, parent=self.master)
        ...
        logger.info(f"Generated Fibonacci sequence up to {limit}")
    ...
    def on_copy(self) -> None:
        """Copy the generated Fibonacci sequence to the system clipboard."""
    ...
    def on_save(self) -> None:
        ...
        # Attempt to parse limit from input for header
        limit_value = self._try_parse_limit()
        ...
        self._write_sequence_to_file(filepath, items, limit_value)
    ...
    def _try_parse_limit(self) -> int | None:
        ...
        try:
            ...
            logger.debug("Could not parse limit from input for file header")
            return None

    def _write_sequence_to_file(
        self, filepath: str, items: tuple, limit_value: int | None
    ) -> None:
        """
        ...
        Args:
            ...
            items: Tuple of string representations of Fibonacci numbers.
            limit_value: Optional limit value for the header.
        """
        sequence_numbers = [int(x) for x in items]
        content_lines = []
        ...
        if limit_value is not None:
            content_lines.append(f"Fibonacci numbers up to {limit_value}:")
        else:
            content_lines.append("Fibonacci numbers:")

        # Add formatted sequence
        content_lines.append(format_sequence(sequence_numbers))
        content = "\n".join(content_lines)
