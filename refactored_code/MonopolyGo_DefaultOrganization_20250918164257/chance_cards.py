...
class ChanceDeck:
    ...
    @staticmethod
    def _move_to_go(game: "Game", player: "Player") -> List[str]:
        """
    ...
    @staticmethod
    def _bank_pays_dividend(game: "Game", player: "Player") -> List[str]:
        """
    ...
    @staticmethod
    def _pay_fine(game: "Game", player: "Player") -> List[str]:
        """
    ...
    @staticmethod
    def _collect_money(game: "Game", player: "Player") -> List[str]:
        """
    ...
    @staticmethod
    def _move_back_3(game: "Game", player: "Player") -> List[str]:
        """
    ...
    @staticmethod
    def _advance_spaces(game: "Game", player: "Player") -> List[str]:
        """
    ...
    @staticmethod
    def _repairs(game: "Game", player: "Player") -> List[str]:
        """
    ...
    @staticmethod
    def _chairman(game: "Game", player: "Player") -> List[str]:
        """
        Charge player to pay all other non-bankrupt players.
    ...
    def draw(self, game: "Game", player: "Player") -> List[str]:
        ...
        Handles special logic for Get Out of Jail Free card which is held
        by a player until used, then returned to the deck.
        ...
        Returns:
            List of message strings describing card effects
        """
        ...
        while attempts < max_attempts:
            ...
            # Skip GOOJF if currently held by a player
    ...
    def return_get_out_of_jail_card(self) -> None:
        """
        Mark the Get Out of Jail Free card as available to be drawn again.

        Called when a player uses their held GOOJF card.
        """
