...
class Food:
    ...
    def __init__(self, grid_width, grid_height, cell_size=DEFAULT_CELL_SIZE):
        ...
        Args:
            ...
            cell_size (int, optional): Size of each cell in pixels. Defaults to DEFAULT_CELL_SIZE.
        """
    ...
    def _get_free_cells(self, snake_positions):
        """
        Calculate which cells are available for food spawning.
        
        Args:
            snake_positions (iterable): Iterable of (x, y) tuples occupied by the snake.
    ...
    def spawn(self, snake_positions):
        ...
        Args:
            snake_positions (iterable): Iterable of (x, y) tuples representing snake body positions.
    ...
    def _get_pixel_rect(self):
        """
        Convert food grid position to pixel-based rectangle for rendering.
        
        Returns:
            pygame.Rect: Rectangle in pixel coordinates, or None if position is not set.
        """
    ...
    def draw(self, surface):
        ...
        """
        pixel_rect = self._get_pixel_rect()
        
        if pixel_rect is None:
            return
        
        pygame.draw.rect(surface, FOOD_COLOR, pixel_rect)