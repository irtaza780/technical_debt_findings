...
class Snake:
    ...
    def _initialize_body(self, head_x, head_y):
        ...
        """
        # Create body from tail to head (left to right)
    ...
    def head(self):
        ...
        Returns:
            Tuple of (x, y) coordinates representing the head position.
        """
        return self.body[-1]
    ...
    def set_direction(self, new_direction):
        ...
        if self._is_reverse_direction(new_direction):
            logger.debug("Direction change blocked: would reverse into self")
            return
        
        if self._is_same_direction(new_direction):
            logger.debug("Direction change ignored: same as current direction")
            return
    ...
    def _is_reverse_direction(self, new_direction):
        """
        Check if the new direction is a reverse of the current direction.
        
        Args:
            new_direction: Tuple of (dx, dy) to check.
            
        Returns:
            True if new_direction reverses current direction and snake length > 1.
        """
        if len(self.body) <= 1:
            return False
        ...
        # Reverse occurs when new direction negates current direction
    ...
    def _is_same_direction(self, new_direction):
        ...
        Returns:
            True if new_direction matches current direction.
        """
    ...
    def move(self, grow=False):
        ...
        Returns:
            Tuple of (x, y) coordinates representing the new head position.
        """
        ...
        logger.debug(f"Snake moved to {new_head}, length: {len(self.body)}")
        return new_head
    ...
    def _calculate_new_head(self):
        ...
        Returns:
            Tuple of (x, y) coordinates for the new head position.
        """
