...
class Claw:
    ...
    Attributes:
        ...
        state: Current state of the claw state machine.
    ...
    def _update_swing(self, dt: float) -> None:
        """
        Update the claw swing angle during swing state.
        ...
        # Clamp angle and reverse direction at boundaries
    ...
    def _find_collision(
        ...
        Args:
            ...
            objects: List of objects to check for collision.
        ...
        for obj in objects:
            if obj.collected:
                continue
            collision_distance = distance(hook_x, hook_y, obj.x, obj.y)
            if collision_distance <= (hook_radius + obj.r):
                return obj
        return None
    ...
    def _update_extend(
        ...
        """
        Update the claw during rope extension.
    ...
    def _update_retract(self, dt: float) -> Optional[Dict]:
        """
        Update the claw during rope retraction.
        
        Args:
            dt: Delta time in seconds.
        
        Returns:
            A collect event dict if an object was successfully collected, or None.
        """
        ...
        if self.rope_length <= self.rope_min:
            ...
            if self.attached is not None:
                ...
                logger.info(f"Collected object: {self.attached}")

            # Reset to swing state
            self.attached = None
            self.state = CLAW_STATE_SWING
            return event
    ...
    def update(
        ...
        """
        Update claw physics and handle state transitions.
        ...
        Returns:
            ...
            Returns None if no collection event occurred.
        """
        if self.state == CLAW_STATE_SWING:
            ...
            return self._update_retract(dt)
